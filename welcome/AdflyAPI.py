...
class AdflyApi():
    BASE_HOST = settings.ADFLY_BASE_HOST
    SECRET_KEY = settings.ADFLY_SECRET_KEY
    PUBLIC_KEY = settings.ADFLY_PUBLIC_KEY
    USER_ID = settings.ADFLY_USER_ID
...
#     #    [3, '1A', '1C']), indent=4)
#
#     print (json.dumps(api.expand(['http://nimbleinity.com/2Wal']), indent=4))
#
...
#         #result_proccess = api.shorten(['http://docs.python.org/library/json.html'], 'q.gs', 'banner', None)
#     #print result_proccess
#         #print (result_proccess['data'][0]['short_url'])
#     #print json.dumps(
